async function ReadCategoriaSoap() {
  try {
    ...
    <SOAP-ENV:Header/>
    <S:Body>
        <ns2:listarTodasLasCategorias xmlns:ns2="http://service/"/>
    </S:Body>
</S:Envelope>
`;
    ...
    const categoria = Array.from(xmlDoc.getElementsByTagName("return")).map(
      (node) => {
...
export default ReadCategoriaSoap;
